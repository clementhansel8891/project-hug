            ...
            {data.map((device, i) => {
              ...
              return (
                <tr key={i} className="group/row">
                  <td className="px-4 py-4 bg-white/2 rounded-l-[1.25rem] border-y border-l border-border group-hover/row:bg-muted transition-colors">
                    <div className="flex items-center gap-4">
                  ...
                  <td className="px-4 py-4 bg-white/2 border-y border-white/5 group-hover/row:bg-muted transition-colors">
                  ...
                  <td className="px-4 py-4 bg-white/2 rounded-r-[1.25rem] border-y border-r border-border group-hover/row:bg-muted text-right transition-colors">
