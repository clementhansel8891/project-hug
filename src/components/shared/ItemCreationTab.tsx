      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex gap-3">
          <Button
            onClick={addRow}
            variant="outline"
            className="rounded-2xl h-12 px-6 font-black italic text-xs uppercase tracking-widest gap-2 bg-card border-border hover:bg-muted/10 text-foreground shadow-sm backdrop-blur-sm"
          >
            ...
            <div>
              ...
              <div className="flex flex-col gap-3 mt-6">
                <Button
                  ...
                  className="rounded-2xl h-11 px-6 font-bold text-xs tracking-tight gap-2 border-border bg-card text-foreground hover:bg-muted/10"
                >
